...
async def giverank(ctx, user: discord.Member, rsn):
    ...
    new_smry.append(str("=IF(E" + str(i) + ">10,\"Clan Friend\",(IF(G" + str(i) + "=\"Normal\",(IF(F" + str(i) + "<1,(IF(C" + str(i) + ">=1500,\"Rune\",(IF(C" + str(i) + ">=1400,\"Adamant\",(IF(C" + str(i) + ">=1200,\"Mithril\",(IF(C" + str(i) + ">=900,\"Steel\",(IF(C" + str(i) + ">=600,\"Iron\",\"Bronze\")))))))))),(IF(F" +str(i) + "<4,(IF(C" + str(i) + ">=1750,\"Rune\",(IF(C" + str(i) + ">=1650,\"Adamant\",(IF(C" + str(i) + ">=1350,\"Mithril\",(IF(C" + str(i) + ">=1000,\"Steel\",(IF(C" + str(i) + ">=650,\"Iron\",\"Bronze\")))))))))),(IF(C" + str(i) +">=2000,\"Rune\",(IF(C" + str(i) + ">=1900,\"Adamant\",(IF(C" + str(i) + ">=1500,\"Mithril\",(IF(C" + str(i) + ">=1100,\"Steel\",(IF(C" + str(i) + ">=700,\"Iron\",\"Bronze\")))))))))))))),(IF(OR(G" + str(i) + "=\"IM\",G" + str(i) + "=\"DeadHCIM\",G" + str(i) + "=\"HCIM\"),(IF(F" + str(i) + "<1,(IF(C" + str(i) + ">=1500,\"Rune\",(IF(C" + str(i) + ">=1300,\"Adamant\",(IF(C" + str(i) + ">=1100,\"Mithril\",(IF(C" + str(i) + ">=800,\"Steel\",(IF(C" + str(i) + ">=500,\"Iron\",\"Bronze\")))))))))),(IF(F" + str(i) + "<4,(IF(C" +str(i) + ">=1750,\"Rune\",(IF(C" + str(i) + ">=1550,\"Adamant\",(IF(C" + str(i) + ">=1250,\"Mithril\",(IF(C" + str(i) + ">=900,\"Steel\",(IF(C" + str(i) + ">=550,\"Iron\",\"Bronze\")))))))))),(IF(C" + str(i) + ">=2000,\"Rune\",(IF(C" + str(i) +">=1800,\"Adamant\",(IF(C" + str(i) + ">=1400,\"Mithril\",(IF(C" + str(i) + ">=1000,\"Steel\",(IF(C" + str(i) + ">=600,\"Iron\",\"Bronze\")))))))))))))),(IF(G" + str(i) +"=\"UIM\",(IF(F" + str(i) + "<1,(IF(C" + str(i) + ">=1500,\"Rune\",(IF(C" + str(i) + ">=1200,\"Adamant\",(IF(C" + str(i) + ">=1000,\"Mithril\",(IF(C" + str(i) + ">=700,\"Steel\",(IF(C" + str(i) + ">=400,\"Iron\",\"Bronze\")))))))))),(IF(F"+str(i) + "<4,(IF(C" + str(i) + ">=1750,\"Rune\",(IF(C" + str(i) + ">=1450,\"Adamant\",(IF(C" + str(i) + ">=1150,\"Mithril\",(IF(C" + str(i) + ">=800,\"Steel\",(IF(C" + str(i) + ">=450,\"Iron\",\"Bronze\")))))))))),(IF(C" + str(i) + ">=2000,\"Rune\",(IF(C" + str(i) + ">=1700,\"Adamant\",(IF(C" + str(i) + ">=1300,\"Mithril\",(IF(C" + str(i) + ">=900,\"Steel\",(IF(C" + str(i) + ">=500,\"Iron\",\"Bronze\")))))))))))))),\"ERROR\")))))))"))
    new_smry.append(str(""))
    new_smry.append(str(""))
